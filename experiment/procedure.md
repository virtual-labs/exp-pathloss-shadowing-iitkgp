...
Step 2:-Enter the values of Gt ,Gr, fc,Tx power in the box provided on the page.Adjust the slider for fixing the antenna height.These are all initial parametes of the experiment.

Step 3:-Drag the mobile by placing the cursor on it and place it at a certain distance from the base station tower.Click on the button TAKE READING and record the values of received power at that position of the mobile and distance of the mobile from the base station,click on the buttons +10m and -10m to change the position of the mobile and record the values of received power in dBm and distance.Click on the button FINISH once you finish ta king readings.Its better if you take 20 readings.
